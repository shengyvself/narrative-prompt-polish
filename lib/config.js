 ...
 * （缺位时静默回退基座——Max-Null 防御式模式）。所有运行时读取走 effectiveConfig()。
 */
...
export const DEFAULTS = {
  // ── 上下文策略 ──
  contextMode: 'full',        // full=C 方案复刻会话 | partial=Max-Null 风格 readSurface | none=只发草稿
  ...
  perSegmentMaxChars: 400,    // partial 模式每段截断（Max-Null 同款）
